(function($) {
  ...
  if (window.cocoonClickHandlerInstalledAddFields !== true) {
    window.cocoonClickHandlerInstalledAddFields = true;
  ...
  if (window.cocoonClickHandlerInstalledRemoveFields !== true) {
    window.cocoonClickHandlerInstalledRemoveFields = true;
